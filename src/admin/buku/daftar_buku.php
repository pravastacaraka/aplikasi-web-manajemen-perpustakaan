<div class="container">
	...
	<div class="row">
		...
		<table cellspacing="0" width="100%">
			...
			<tr> 
				<!-- ALERT JIKA DATA 0 -->
				<td colspan="9" class="baris-data"><div style="text-align: center;font-size: 17px; padding: 20px">Data Tidak Ditemukan</div></td>
			</tr>
			<?php
				} else {
			...
			<tr class="baris-data">
				...
				<td align="center" style="padding-right: 1px; width: 4%"><div style="text-align: center; font-size: 22px;">
					<a href="?page=buku&action=edit&id=<?= $data['id']; ?>" title="Ubah Data"><i class="far fa-edit btn-fa btn-fa-info"></i></a>
				</div></td>
				<td align="center" style="padding-left: 1px; width: 4%"><div style="text-align: center;font-size: 22px">
					<a onclick="return confirm ('Apakah anda yakin untuk menghapus data ini?')" href="?page=buku&action=del&id=<?= $data['id']; ?>" title="Hapus Data"><i class="far fa-trash-alt btn-fa btn-fa-danger"></i></a>
				</div></td>
			</tr>
			<?php
					}
			...
			<!-- BARIS PAGINATION -->
			<tr>
				<td colspan="9" class="baris-paging">
					<ul class="pagination">
					<!-- LINK FIRST AND PREV -->
					<?php
			...
			<tr style="text-align: center">
				<td colspan="9"><br><a href="?page=buku&action=tambah" class="btn-edit" title="Tambah Buku">Tambah Daftar Buku</a></td>
			</tr>
